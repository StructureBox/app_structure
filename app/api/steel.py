...
@router.post("/get_section/h")
def get_h_section(input_data: HSectionInput):
    """
...
@router.post("/get_section/wc")
def get_wc_section(input_data: WCSectionInput):
    """
...
@router.post("/get_section/lc")
def get_lc_section(input_data: LCSectionInput):
    """
...
@router.post("/get_section/box")
def get_box_section(input_data: BOXSectionInput):
    """
...
@router.post("/get_section/")
def get_pipe_section(input_data: PIPESectionInput):
    """
...
@router.get("/get_section/excel/h")
def get_h_section_excel(
    ...
    例:
    `/get_section/excel/h?H=300&B=150&tw=6.5&tf=9`
    """
...
@router.get("/get_section/excel/wc")
def get_wc_section_excel(
    ...
    例:
    `/get_section/excel/wc?H=300&B=100&tw=8&tf=12`
    """
...
@router.get("/get_section/excel/lc")
def get_lc_section_excel(
    ...
    例:
    `/get_section/excel/lc?H=150&B=75&C=20&t=2.5`
    """
...
@router.get("/get_section/excel/box")
def get_box_section_excel(
    ...
    例:
    `/get_section/excel/box?B=150&t=6`
    """
...
@router.get("/get_section/excel/pipe")
def get_pipe_section_excel(
    ...
    例:
    `/get_section/excel/pipe?D=150&t=6`
    """
